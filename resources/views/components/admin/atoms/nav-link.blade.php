...
<a
    {{ $attributes->merge(['class' => "justify-start inline-flex items-center md:text-base text-xl md:py-2 px-2 py-4 leading-5 transition duration-150 ease-in-out gap-2 focus:outline-none $classes"]) }}>
    {{ $slot }}
</a>
