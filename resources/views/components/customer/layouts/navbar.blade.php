    ...
    <nav class="md:flex md:items-center md:justify-between w-[92%] mx-auto">
        <div class="flex justify-between items-center p-3 md:py-0">
            <a href="/" class="flex items-center text-xl gap-3 hover:text-yellow-primary group">
                <svg width="30" class="aspect-ratio fill-white group-hover:fill-yellow-primary mb-1"
                        ...
                        <div class="sm:flex sm:items-center">
                            <div class="mx-1 relative">
                                <x-dropdown align="left" width="w-40">
                                    <x-slot name="trigger">
                                        <button type="button"
                                            class="inline-flex items-center px-3 py-1.5 border border-transparent text-base leading-4 font-medium rounded-md text-white bg-brown-primary hover:text-yellow-primary focus:outline-none focus:bg-brown-secondary active:bg-brown-secondary transition ease-in-out duration-150">
