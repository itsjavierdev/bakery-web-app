...
<button
    {{ $attributes->merge(['type' => 'submit', 'class' => "font-medium inline-flex items-center justify-center px-4 py-2 h-14 rounded uppercase tracking-widest focus:bg-opacity-95 focus:outline-none focus:ring-offset-2 focus:ring-2 focus:ring-brown-primary active:bg-opacity-95 transition ease-in-out duration-150 $classSize $classVariant"]) }}>
    {{ $slot }}
</button>
