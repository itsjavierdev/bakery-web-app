    ...
    <x-dialog-modal wire:model.live="confirmingPassword">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4" x-data="{}"
                ...
                <x-inputs.text type="password" class="mt-1 block w-3/4" placeholder="{{ __('Password') }}"
        ...
        <x-slot name="footer">
            <x-button color="outline" wire:click="stopConfirmingPassword" wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-button>
