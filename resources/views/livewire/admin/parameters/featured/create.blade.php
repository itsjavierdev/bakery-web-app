    ...
    <x-inputs.group>
        ...
        @if ($image)
            <div class="mt-3 relative {{ $put_filter ? 'content-banner' : '' }}">
                ...
                @if ($title)
                    <p class="text-4xl text-white italic text-center absolute w-full h-full flex items-center justify-center z-50 top-0 left-0 [text-shadow:_0_4px_0_rgb(0_0_0_/_50%)]"
