<div class="p-6">
    <livewire:admin.products.delete redirect="productos.index" />
    <x-detail-show>
        <div>
            ...
            <x-detail-row title="Fecha de registro">
                <x-date-format>{{ $product->category->created_at }}</x-date-format>
            </x-detail-row>
            <x-detail-row title="Fecha de modificación">
                <x-date-format>{{ $product->category->updated_at }}</x-date-format>
            </x-detail-row>
