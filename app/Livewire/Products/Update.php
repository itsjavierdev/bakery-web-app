...
class Update extends Component
{
    ...
    public function update()
    {
        ...
        redirect()->route('productos.index')->with('flash.banner', 'Producto actualizado correctamente')->with('flash.bannerStyle', 'success');
    }
    ...
    public function render()
    {
        ...
        ])->layout('layouts.app-header', ['title' => 'Actualizar producto', 'titleAlign' => 'center']);
    }
    //validation rules
