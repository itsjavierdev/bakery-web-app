...
class Create extends Component
{
    ...
    {
        return view('livewire.admin.parameters.delivery-times.create')->layout('layouts.admin-header', ['title' => 'Agregar horario', 'titleAlign' => 'center']);
    }
    ...
    public function save()
    {
        ...
        DeliveryTime::create(['time' => $this->time, 'for_delivery' => $this->for_delivery, 'available' => true]);
