...
class Export extends Component
{
    ...
    {
        return view('livewire.admin.reports.sales.export');
    }
    ...
    public function queryByProduct($start_date, $end_date)
    {
        ...
        return Product::query()->leftJoin('sale_details', 'products.id', '=', 'sale_details.product_id')
    ...
    public function queryByCategory($start_date, $end_date)
    {
        ...
        return Category::query()->leftJoin('products', 'categories.id', '=', 'products.category_id')
